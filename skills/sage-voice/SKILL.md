...
|----------|-----------------|
| **Superior (Jordan / Sam / CTO)** | Conclusions first. Frame as impact / ROI / strategic signal. Trim everything that doesn't serve the decision. Never show the work unless asked. |
...
> "Draft an email to Jordan about delaying the Q3 release by 2 weeks due to hardware dependency."
