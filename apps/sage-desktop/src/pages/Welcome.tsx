        ...
        return (
          <div className="welcome-screen">
            <p className="welcome-greeting">
              ...
              to reveal your <strong>{t("welcome.thinkingSpectrum")}</strong>.
            </p>
            <div className="welcome-actions">
              <button className="btn btn-primary" onClick={() => goTo(1)}>{t("welcome.getStarted")}</button>
            </div>
          </div>
        );
          ...
          <div className="welcome-screen">
            ...
            <div className="welcome-card spectrum-card">
              ...
              <p className="spectrum-note">
                {t("welcome.spectrumNote").split("\n").map((line, i) => (
                  <span key={i}>{line}{i === 0 ? <br /> : null}</span>
                ))}
              </p>
            </div>
            <div className="welcome-actions">
              <button className="btn btn-primary" onClick={() => goTo(4)}>{t("welcome.continue")}</button>
            </div>
          </div>
        );
            ...
            <div className="welcome-card">
              {readyProviders.length > 0 ? (
                ...
                <>
                  ...
                  <div className="form-group">
                    <label className="form-label">{t("welcome.apiKeyLabel")}</label>
                    <input
                      className="form-input"
                      type="password"
                      value={apiKey}
                  ...
                  <div className="welcome-actions">
                    ...
                    {testResult === "ok" && (
                      <span className="provider-status ready">{t("welcome.connSuccess")}</span>
                    )}
                    {testResult === "fail" && (
                      <span className="provider-status error">{t("welcome.connFail")}</span>
                    )}
                  </div>
                </>
              )}
