...
fn test_save_coach_insight() {
    let store = Store::open_in_memory().unwrap();
    store.save_coach_insight("Evan 重视团队自主性").unwrap();
